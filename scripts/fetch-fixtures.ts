 ...
 *   1. Add the URL to FIXTURE_URLS below
 *   2. Run this script to save the HTML fixture
 *   3. Add a matching entry to the TEST_CASES array in src/extractor.test.ts
 */
...
const FIXTURE_URLS = [
  ...
  // ↑ Add new URLs here — then run this script and add a matching entry to src/extractor.test.ts
];
